...
LS_APP = BASE_PATH .. "/double.ls"
LOAD_SONG_APP = BASE_PATH .. "/load_song.lua"
--XMPP_MSG_APP = BASE_PATH .. "/send_xmpp.js"
XMPP_MSG_APP = "java -jar /home/ashok/java/PubSubSend.jar "
...
function get_xmpp_pubsub_id(gid)
	return "dogsgroup_playlst"
end
...
function send_playlist_xmpp_msg(uid,gid,song)
	...
	print(XMPP_MSG_APP .. " " .. get_xmpp_pubsub_id(gid) .. " " .. uid .. " \"" .. song_metada .. "\"")
	os.execute(XMPP_MSG_APP .. " " .. get_xmpp_pubsub_id(gid) .. " " ..  uid .. " \"" .. song_metada .. "\"")
end
